...
Parkingservice : Elasticsearch 를 이용한 Kibana 대시보드 시각화와 기능별 단위테스트를 통해 / 차량의 입출차 기록을 기반으로 요금을 계산하고, 결제 및 정기권 관리하는 서비스 [바로가기](https://github.com/dilution0216/ParkingService) <br>
