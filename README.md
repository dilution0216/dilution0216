...
parkingservice : 차량의 입출차 기록을 기반으로 요금을 계산하고, 결제 및 정기권 관리하는 서비스 [바로가기](https://github.com/dilution0216/ParkingService)  Spring AOP를 통해 모든 API 호출 로그 기록후, Elasticsearch에 저장하여 Kibana 대시보드 시각화였음 <br>
